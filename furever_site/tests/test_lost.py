...
def test_login_to_lost(driver):
    ...
    driver.get("http://127.0.0.1:8000/lost")
    ...
    assert "Add new lost pet" in success_message



def test_report_lost_pet(driver):
    # Open the Lost 
    parent_div = driver.find_element(By.XPATH, "/html/body/div")
    init_count=len(parent_div.find_elements(By.TAG_NAME, "div"))
    # Click on the button to report a lost pet
    driver.find_element(By.XPATH, "/html/body/a").click()
    
    # Fill in the form with the lost pet's details
